...
class ThemeController extends GetxController implements GetxService {
  ...
  int pickColorInt = 0xffff9800;
  //0xffff9800
  Color _pickColor = Color(0xffff9800);
  Color get pickColor => _pickColor;

  Color _pickSecondaryColor = Color(0xffff9800);
  ...
  void _loadCurrentTheme() async {
    ...
    if (global.sp!.getInt('primaryColor') != null) {
      ...
      _pickColor = Color(0xffff9800);
      _pickSecondaryColor = Color(0xffff9800);
      pickColorInt = 0xffff9800;
    }
    update();
  }
