...
import 'package:callvcal/views/customer_support/customer_support_chat_screen.dart';
import 'package:callvcal/views/customer_support/helpAndSupportScreen.dart';
    ...
    return Scaffold(
      ...
      bottomSheet: GetBuilder<CustomerSupportController>(
        ...
        return CustomBottomButton(
          title: tr('Chat With Customer Support'),
          onTap: () async {
            global.showOnlyLoaderDialog(context);
