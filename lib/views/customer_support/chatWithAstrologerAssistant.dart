...
class ChatWithAstrologerAssistant extends StatelessWidget {
  bool appbar;
  ChatWithAstrologerAssistant({Key? key, this.appbar=false}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return
      ...
      Scaffold(
        appBar: AppBar(
          title: Text("Astrologer Assistant",).tr(),
        ),
        body: Container(
            ...
            child: astrologerAssistantController.assistantList.isEmpty
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    print("build image:- ${astrologerAssistantController.assistantList[index].profileImage}");
                    return GestureDetector(
                      onTap: () async {
                        global.isInAssistantScreen=true;
                        print("fcm:- ${astrologerAssistantController
                            .assistantList[index].fcmToken}");
                        Get.to(() => ChatWithAstrologerAssistantScreen(
                          flagId: 1,
                          profileImage: astrologerAssistantController
                              .assistantList[index].profileImage!,
                          ...
                          chatId: 1,
                          fcmtoken: astrologerAssistantController
                              .assistantList[index].fcmToken.toString(),
                        ));
                      },
                      onLongPress: () async {
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: astrologerAssistantController
                                    ...
                                    child: Image.asset(
                                      ...
                                      : CachedNetworkImage(
                                    imageUrl:
                                    global.buildImageUrl('${astrologerAssistantController.assistantList[index].profileImage}'),
                                    imageBuilder:
        ...
        bottomSheet: CustomBottomButton(
          title: tr('Chat With Astrologer Assistant'),
          onTap: () {
                    ...
                    return GestureDetector(
                      onTap: () async {
                        ...
                        Get.to(() => ChatWithAstrologerAssistantScreen(
                          flagId: 1,
                          profileImage: astrologerAssistantController
                              .assistantList[index].profileImage.toString(),
                          astrologerName: astrologerAssistantController
                              .assistantList[index].astrologerName!,
                          fireBasechatId: astrologerAssistantController
                              .assistantList[index].chatId,
