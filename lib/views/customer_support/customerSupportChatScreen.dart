...
import 'package:callvcal/views/customer_support/chatWithAstrologerAssistant.dart';
import 'package:callvcal/views/customer_support/chatWithCustomerSupport.dart';
            ...
            children: [
              TabBar(indicatorColor: Get.theme.primaryColor, tabs: [
                ...
                Container(
                    height: 35,
                    alignment: Alignment.center,
                    child: Text('Astrologer Assistant').tr()),
              ]),
              Expanded(
