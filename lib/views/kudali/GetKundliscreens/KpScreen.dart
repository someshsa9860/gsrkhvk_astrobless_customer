...
import 'package:callvcal/views/kudali/FullSizeSvgPainter.dart';
import 'package:callvcal/views/kudali/GetKundliscreens/kundlichartscreen.dart';
...
class _KpScreenState extends State<KpScreen> {
  ...
  void _fetchDataForKpTab(String tabKey) async {
    ...
    print('Fetching  with userId ${widget.userid}');
