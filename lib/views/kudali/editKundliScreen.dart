...
class EditKundliScreen extends StatelessWidget {
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: DropdownButton(
                                    ...
                                    value: kundliController.innitialValue(1, [
                                      'Male',
                                      'Female',
                                      'Other',
                                    ]),
                          ...
                          CommonSmallTextFieldWidget(
                            controller:
                                kundliController.editBirthDateController,
                            titleText: "",
                          ...
                          CommonSmallTextFieldWidget(
                            controller:
                                kundliController.editBirthTimeController,
                            titleText: "",
  ...
  Future _selectDate(
    ...
    if (datePicked != null) {
      kundliController.editBirthDateController.text = formatDate(datePicked, [
        dd,
        '-',
        mm,
        '-',
  ...
  Future _boySelectBirthDateTime(
    ...
    if (pickedTime != null) {
      ...
      kundliController.editBirthTimeController.text = formattedTime;
      kundliController.update();
    } else {
