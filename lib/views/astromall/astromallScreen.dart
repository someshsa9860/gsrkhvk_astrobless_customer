                              ...
                              onTap: () async {
                                ...
                                Get.to(() => AstroProductScreen(
                                      ...
                                      productCategoryId: astromallController
                                          .astroCategory[0].id,
                                      sliderImage:
                                          "${astromallController.astroCategory[0].categoryImage}",
                                    ));
                              },
                              ...
                              onTap: () async {
                                ...
                                Get.to(() => AstroProductScreen(
                                      ...
                                      productCategoryId: astromallController
                                          .astroCategory[1].id,
                                      sliderImage:
                                          "${astromallController.astroCategory[1].categoryImage}",
                                    ));
                              },
                              child: CachedNetworkImage(
                                imageUrl: global.buildImageUrl(
                              ...
                              onTap: () async {
                                ...
                                Get.to(() => AstroProductScreen(
                                      ...
                                      productCategoryId: astromallController
                                          .astroCategory[2].id,
                                      sliderImage:
                                          "${astromallController.astroCategory[2].categoryImage}",
                                    ));
                              },
                              child: CachedNetworkImage(
                                imageUrl: global.buildImageUrl(
                    ...
                    child: SizedBox(
                      ...
                      child: IgnorePointer(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText:
                                tr("Let's find what you're looking for..."),
                            hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 12,
