...
import 'package:callvcal/views/customer_support/customerSupportChatScreen.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text('Report intake Form').tr(),
          leading: IconButton(
            onPressed: () => Get.back(),
            ...
            child: GetBuilder<ReportController>(builder: (c) {
              return Column(
                ...
                children: [
                  ...
                  DropDownWidget(
                    item: ['English', 'Hindi','Gujarati','Marathi','Bengali','Kannada','Malayalam','Tamil','Telugu'],
                          ...
                          children: [
                            Expanded(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ButtonStyle(
                                  maximumSize:
                                      WidgetStateProperty.all(Size(80, 40)),
