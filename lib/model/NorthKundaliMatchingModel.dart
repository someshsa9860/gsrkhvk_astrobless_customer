...
NorthKundaliMatchingModel northKundaliMatchingModelFromJson(dynamic str) => NorthKundaliMatchingModel.fromJson(json.decode(str));

dynamic northKundaliMatchingModelToJson(NorthKundaliMatchingModel data) => json.encode(data.toJson());
