...
DashDetailsModel dashDetailsModelFromJson(dynamic str) =>
    DashDetailsModel.fromJson(json.decode(str));

dynamic dashDetailsModelToJson(DashDetailsModel data) =>
...
class MahaDashaResponse {
  ...
  dynamic startYear;
  dynamic dashaStartDate;
  dynamic dashaRemainingAtBirth;
...
class Dasha {
  dynamic prediction;
  dynamic dasha;
  dynamic dashaEndYear;
  dynamic dashaStartYear;
  dynamic planetInZodiac;
  ...
  factory ResponseElement.fromJson(Map<String, dynamic> json) =>
      ResponseElement(
        mainDasha: json.containsKey("main_dasha") &&
            ...
            : null,
        mainDashaLord:
            json["main_dasha_lord"] == null ? null : json["main_dasha_lord"],
