...
VedicPanchangModel vedicPanchangModelFromJson(dynamic str) => VedicPanchangModel.fromJson(json.decode(str));

dynamic vedicPanchangModelToJson(VedicPanchangModel data) => json.encode(data.toJson());
...
class AdvancedDetails {
  ...
  dynamic moonRise;
  dynamic moonSet;
  dynamic nextFullMoon;
  dynamic nextNewMoon;
  Masa? masa;
  dynamic moonYoginiNivas;
  double? ahargana;
  Years? years;
  dynamic vaara;
  dynamic dishaShool;
...
class Masa {
  dynamic amantaNumber;
  dynamic amantaDate;
  dynamic amantaName;
  dynamic alternateAmantaName;
  dynamic amantaStart;
  dynamic amantaEnd;
  bool? adhikMaasa;
  dynamic ayana;
  dynamic realAyana;
  dynamic purnimantaDate;
  dynamic purnimantaNumber;
  dynamic purnimantaName;
  dynamic alternatePurnimantaName;
  dynamic purnimantaStart;
  dynamic purnimantaEnd;
  dynamic moonPhase;
  dynamic paksha;
  dynamic ritu;
  dynamic rituTamil;
...
class Years {
  dynamic kali;
  dynamic saka;
  dynamic vikramSamvaat;
  dynamic kaliSamvaatNumber;
  dynamic kaliSamvaatName;
  dynamic vikramSamvaatNumber;
  dynamic vikramSamvaatName;
  dynamic sakaSamvaatNumber;
  dynamic sakaSamvaatName;
