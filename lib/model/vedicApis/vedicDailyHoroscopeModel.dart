...
VedicDailyHoroscopeModel vedicDailyHoroscopeModelFromJson(dynamic str) => VedicDailyHoroscopeModel.fromJson(json.decode(str));

dynamic vedicDailyHoroscopeModelToJson(VedicDailyHoroscopeModel data) => json.encode(data.toJson());
...
class RecordList {
  dynamic id;
  dynamic horoscopeType;
  dynamic title;
  dynamic description;
  dynamic horoscopeSignId;
  DateTime? createdAt;
  DateTime? updatedAt;
