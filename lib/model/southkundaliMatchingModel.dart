...
SouthKundaliMatchingModel southKundaliMatchingModelFromJson(dynamic str) => SouthKundaliMatchingModel.fromJson(json.decode(str));

dynamic southKundaliMatchingModelToJson(SouthKundaliMatchingModel data) => json.encode(data.toJson());
