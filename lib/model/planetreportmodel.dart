...
PlanetReportModel planetReportModelFromJson(dynamic str) =>
    PlanetReportModel.fromJson(json.decode(str));

dynamic planetReportModelToJson(PlanetReportModel data) =>
...
class Response {
  dynamic planetConsidered;
  dynamic planetLocation;
  dynamic planetNativeLocation;
  dynamic planetZodiac;
  dynamic zodiacLord;
  dynamic zodiacLordLocation;
  dynamic zodiacLordHouseLocation;
  dynamic generalPrediction;
  dynamic zodiacLordStrength;
  dynamic planetStrength;
  dynamic planetDefinitions;
  dynamic gayatriMantra;
  dynamic qualitiesLong;
  dynamic qualitiesShort;
  dynamic affliction;
  dynamic personalisedPrediction;
  dynamic verbalLocation;
  dynamic planetZodiacPrediction;
